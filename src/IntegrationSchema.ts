...
import MessageJson from './schemas/Message.json';
export const Message = MessageJson;
...
import ConversationJson from './schemas/Conversation.json';
export const Conversation = ConversationJson;
